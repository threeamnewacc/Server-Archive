...
public class PasteHollow implements CommandExecutor {
	...
	public boolean onCommand(CommandSender commandSender, Command command, String s, String[] args) {
		...
		SessionManager.getSession(player).pasteHollow(player.getLocation(), player);
		HistoryManager.savePaste(player);
		player.sendMessage(GEdit.PREFIX + ChatColor.GREEN + "Your selection has been hollow pasted.");
