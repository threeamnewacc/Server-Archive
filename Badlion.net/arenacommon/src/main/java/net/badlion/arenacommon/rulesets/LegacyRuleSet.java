...
public class LegacyRuleSet extends KitRuleSet {

    public LegacyRuleSet(int id, String name) {
        super(id, name, new ItemStack(Material.WRITTEN_BOOK), ArenaCommon.ArenaType.PEARL, KnockbackType.SPEED_II, true, false);
	    ...
	    this.info8Sign[3] = "No GApples/Rod";
    }
