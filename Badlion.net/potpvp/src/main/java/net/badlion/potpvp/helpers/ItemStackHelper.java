...
public class ItemStackHelper {
	...
	public static void initialize() {
		...
		if (PotPvP.getInstance().getServer().getSpigotJarVersion() == Server.SERVER_VERSION.V1_9) {
			ItemStackHelper.itemStackTypes.put(Material.SHIELD, ItemType.SHIELD);

			ItemStackHelper.itemStackTypes.put(Material.ELYTRA, ItemType.ARMOR);

			ItemStackHelper.itemStackTypes.put(Material.SPECTRAL_ARROW, ItemType.WEAPON);
			ItemStackHelper.itemStackTypes.put(Material.TIPPED_ARROW, ItemType.WEAPON);
		}
		...
		if (PotPvP.getInstance().getServer().getSpigotJarVersion() == Server.SERVER_VERSION.V1_9) {
			ItemStackHelper.itemStackTypes.put(Material.SPLASH_POTION, ItemType.POTION);
			ItemStackHelper.itemStackTypes.put(Material.LINGERING_POTION, ItemType.POTION);
		}
