...
public class BuildUHCRuleSet extends KitRuleSet {
    ...
    public BuildUHCRuleSet(int id, String name) {
        super(id, name, new ItemStack(Material.LAVA_BUCKET), ArenaManager.ArenaType.BUILD_UHC, false, false);
	    ...
	    if (PotPvP.getInstance().getServer().getSpigotJarVersion() == Server.SERVER_VERSION.V1_9) {
		    ...
		    // TODO: MOJANG BUG
		    //this.defaultInventoryKit[9] = new ItemStack(Material.SPECTRAL_ARROW, 64);
	    }
