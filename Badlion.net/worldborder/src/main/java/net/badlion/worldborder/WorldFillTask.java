...
public class WorldFillTask implements Runnable
{
	...
	public void finish()
	{
        ...
        // GStart - Hook into our other plugins if need be
        Bukkit.getServer().getPluginManager().callEvent(new WorldFillerTaskCompleteEvent(this.world.getName(), this.border));
        // GEnd
	}
	...
	private void sendMessage(String text)
	{
        ...
        Bukkit.getPluginManager().callEvent(new WorldBorderFillMessageEvent("[Fill] " + text));
