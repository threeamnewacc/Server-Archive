...
public class StatsInventory {
	...
	public void openPlayerStatsInventory(Player player, UUID uuid, String username, MiniStatsPlayer miniStatsPlayer) {
		...
		smellyInventory.getMainInventory().addItem(
				ItemStackUtil.createItem(Material.BEACON, ChatColor.GREEN + "" + miniStatsPlayer.getWins() + " wins"));

		smellyInventory.getMainInventory().addItem(
				ItemStackUtil.createItem(Material.REDSTONE_BLOCK, ChatColor.GREEN + "" + miniStatsPlayer.getLosses() + " losses"));
