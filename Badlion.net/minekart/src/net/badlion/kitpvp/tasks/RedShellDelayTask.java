...
public class RedShellDelayTask extends BukkitRunnable {

	private MineKart plugin;
	private Racer racer;
	
	public RedShellDelayTask(MineKart plugin, Racer racer) {
		this.plugin = plugin;
		this.racer = racer;
	}
	...
	public void run() {
		...
		this.racer.getPlayer().sendMessage(ChatColor.RED + "Hit by red missile.  Stunned for 3 seconds.");
