...
final class NTLMEngineImpl implements NTLMEngine
{
    ...
    static String getResponseFor(final String message, final String username, final String password, final String host, final String domain) throws NTLMEngineException {
        String response;
