...
public class EM {
	...
	public static Map<Class<? extends Entity>, EntityCollection<? extends Entity>> entityClassMap = new LinkedHashMap<>();

	@SuppressWarnings("unchecked")
	public static <T extends Entity> EntityCollection<T> getEntitiesCollectionForEntityClass(Class<T> entityClass) {
		return (EntityCollection<T>) entityClassMap.get(entityClass);
	}
	...
	public static void setEntitiesCollectionForEntityClass(Class<? extends Entity> entityClass, EntityCollection<? extends Entity> entities) {
		entityClassMap.put(entityClass, entities);
	}
	...
	public static void saveAllToDisc() {
		for (EntityCollection<? extends Entity> ec : entityClassMap.values()) {
			ec.saveToDisc();
		}
	}
