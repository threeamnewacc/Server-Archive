...
public class CmdSafeunclaimall extends FCommand {
	...
	@Override
	public void perform() {
		Board.unclaimAll(Factions.getInstance().getSafeZone().getId());
		msg("<instance>You unclaimed ALL safe zone land.");

		if (Conf.logLandUnclaims) {
			HCFactions.getInstance().log(fme.getName() + " unclaimed all safe zones.");
		}
	}
