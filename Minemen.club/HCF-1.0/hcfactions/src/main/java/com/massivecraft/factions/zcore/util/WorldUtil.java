...
public class WorldUtil {
	 ...
	 *
	 * Environment env = WorldEnv.getAll(name); if (env == null) { P.log(Level.WARNING, "Failed to load world. Environment was unknown."); return false; }
	 *
	 * HCFactions.getInstance().getServer().createWorld(name, env); return true; }
	 */
