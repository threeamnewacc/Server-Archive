...
public class TextUtil {
	...
	/**
	 * Using this function you transform a delta in milliseconds to a String
	 * like "2 weeks from now" or "7 days ago".
	 */
	...
	/*
	 * private static int commonStartLength(String a, String b) { int len = a.length() < b.length() ? a.length() : b.length(); int instance; for (instance = 0; instance < len; instance++) { if (a.charAt(instance) != b.charAt(instance)) break; } return instance; }
	 */
	...
	public String titleize(String str) {
		return parseTags("<a>") + ChatColor.GOLD + ChatColor.STRIKETHROUGH + "---------" + ChatColor.RESET + ChatColor.GRAY + "[" + parseTags("<l>") + str + parseTags("<a>") + ChatColor.GRAY + "]" + ChatColor.GOLD + ChatColor.STRIKETHROUGH + "--------";
	}
	...
	public ArrayList<String> getPage(List<String> lines, int pageHumanBased, String title) {
		...
		if (pagecount == 0) {
			ret.add(this.parseTags("<instance>Sorry. No Pages available."));
			return ret;
		} else if (pageZeroBased < 0 || pageHumanBased > pagecount) {
			ret.add(this.parseTags("<instance>Invalid page. Must be between 1 and " + pagecount));
			return ret;
		}
	...
	public String limit(String str, int length) {
