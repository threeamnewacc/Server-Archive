...
public abstract class VanillaCommand extends Command {
    ...
    public static final int MAX_COORD = 30000000;
    public static final int MIN_COORD_MINUS_ONE = -30000001;
    public static final int MIN_COORD = -30000000;
    ...
    public int getInteger(CommandSender sender, String value, int min, int max) {
        return getInteger(sender, value, min, max, false);
    }

    public int getInteger(CommandSender sender, String value, int min, int max, boolean Throws) {
        int i = min;
