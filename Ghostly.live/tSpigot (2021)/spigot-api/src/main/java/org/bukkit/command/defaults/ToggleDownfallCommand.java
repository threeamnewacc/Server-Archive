...
public class ToggleDownfallCommand extends VanillaCommand {
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (world == null) {
                sender.sendMessage("&cNo world exists with the name '" + args[0] + "'");
                return true;
            }
        ...
        Command.broadcastCommandMessage(sender, "&aToggling downfall &r" + (world.hasStorm() ? "&coff" : "&2on") + "&a for world '&r" + world.getName() + "&a'");
