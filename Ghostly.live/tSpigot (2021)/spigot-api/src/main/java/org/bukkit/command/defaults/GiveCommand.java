            ...
            if (material != null) {
                ...
                if (args.length >= 5) {
                    try {
                        ...
                        player.sendMessage("&cNot a valid tag");
                        return true;
                    }
                }
                ...
                Command.broadcastCommandMessage(sender, "&aGave &r" + player.getName() + "&a some &r" + material.getId() + " (" + material + ")");
            } else {
                sender.sendMessage("&cThere's no item called " + args[1]);
            }
        } else {
