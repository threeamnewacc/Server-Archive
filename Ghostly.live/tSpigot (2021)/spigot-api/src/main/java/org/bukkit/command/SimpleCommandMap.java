    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        try {
            if(target.timings == null) {
                target.timings = co.aikar.timings.TimingsManager.getCommandTiming(TimingsManager.getPluginByClassloader(target.getClass()).getName(), target); // Spigot
            }
