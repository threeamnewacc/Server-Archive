...
import me.enzol.spigot.event.potion.PotionEffectAddEvent;
import me.enzol.spigot.event.potion.PotionEffectExpireEvent;
import me.enzol.spigot.event.potion.PotionEffectExtendEvent;
import me.enzol.spigot.event.potion.PotionEffectRemoveEvent;
import me.enzol.spigot.knockback.KnockbackModule;
import me.enzol.spigot.knockback.KnockbackProfile;
import me.enzol.spigot.util.CraftPotionUtil;
...
public abstract class EntityLiving extends Entity {
    ...
    public KnockbackProfile getKnockback(){
        return this.knockback == null ? KnockbackModule.get().getActiveProfile() : this.knockback;
    }


    public KnockbackProfile getPrivateKnockback(){
    ...
    public boolean isInCombo = false;

    public void setInCombo(boolean inCombo){
        this.isInCombo = inCombo;
    }
