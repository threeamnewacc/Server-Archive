                ...
                if (true || !list1.isEmpty()) {
                    ...
                    if (!event.isCancelled() && list != null && !list.isEmpty()) {
                        for (LivingEntity victim : event.getAffectedEntities()) {
                            ...
                            if(this.getShooter().getBukkitEntity() instanceof CraftPlayer){
                                CraftPlayer shooter = (CraftPlayer) this.getShooter().getBukkitEntity();
                                if(entityliving instanceof EntityPlayer && !shooter.canSee(((EntityPlayer) entityliving).getBukkitEntity())){
                                    continue;
                                }
                            }
